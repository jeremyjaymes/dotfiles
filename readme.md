# jeremyjaymes dotfiles (forked from Dries's Dotfiles)

* Removed Mackup from workflow. Great tool just didn't require it in my set up. There are also a few additional differences in my setup but I'm choosing to preserve and edited version the original readme below (for now) since the majority of it still applies.*
...
8. <del>Make sure Dropbox is set up and synced</del>
9. <del>Restore preferences by running `mackup restore`</del>
